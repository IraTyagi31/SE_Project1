...
//		((JPanel) win.getContentPane()).setOpaque(false);
		...
		//---changes---
		win=SuperView.addJFrame("ControlDesk");
...
//		controlsPanel.add(assignPanel);
		...
		addParty=SuperView.addButton("Add Party",controlsPanel);
		addParty.addActionListener(this);
		assign=SuperView.addButton("Assign Lanes",controlsPanel);
		assign.addActionListener(this);
		finished=SuperView.addButton("Finished",controlsPanel);
