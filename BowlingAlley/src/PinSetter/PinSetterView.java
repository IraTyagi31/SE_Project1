...
public class PinSetterView implements PinsetterObserver {
	...
	for(int i=1;i<=10;i++)
	{
		...
		panelArray[i-1] = new JPanel();
		labelArray[i-1] = new JLabel(str);
		panelArray[i-1].add(labelArray[i-1]);
	}
...
//	pinVect.add ( tenL );	
	...
	pins.add ( panelArray[6] );
	pins.add ( new JPanel ( ) );
	pins.add ( panelArray[7] );
	pins.add ( new JPanel ( ) );
	pins.add ( panelArray[8] );
	pins.add ( new JPanel ( ) );
	pins.add ( panelArray[9] );
	
	//*****************************Third Row***********
		
	pins.add ( new JPanel ( ) );
	pins.add ( panelArray[3] );
	pins.add ( new JPanel ( ) );
	pins.add ( panelArray[4] );
	pins.add ( new JPanel ( ) );
	pins.add ( panelArray[5] );
	...
	pins.add ( new JPanel ( ) );
	pins.add ( new JPanel ( ) );
	pins.add ( panelArray[1] );
	pins.add ( new JPanel ( ) );
	pins.add ( panelArray[2] );
	pins.add ( new JPanel ( ) );
	pins.add ( new JPanel ( ) );
