...
//		((JPanel) win.getContentPane()).setOpaque(false);
		//
		//---changes---
		win=SuperView.addJFrame("Add Party");
...
//		addPatronPanel.add(addPatron);
		...
		addPatron=SuperView.addButton("Add to Party", buttonPanel);
		addPatron.addActionListener(this);
...
//		remPatronPanel.add(remPatron);
		remPatron=SuperView.addButton("Remove Member", buttonPanel);
		remPatron.addActionListener(this);
...
//		newPatronPanel.add(newPatron);
		newPatron=SuperView.addButton("New Patron", buttonPanel);
		newPatron.addActionListener(this);
...
//		buttonPanel.add(finishedPanel);
	...
	//if statements changed to else if
	//if conditions reduced using appropriate operators
	//---changes---
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if (e.getSource().equals(remPatron) && selectedMember != null) {
